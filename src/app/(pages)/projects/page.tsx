...
const page = async () => {
    ...
    const GlobalChatApp = ref(storage, "projects/GlobalChatApp.png");
    const ConceptSketch = ref(storage, "projects/SketchConcept.png");
    const FrontendPlayground = ref(storage, "projects/FrontendPlayground.png");
    ...
    const globalChatAppUrl = await getDownloadURL(GlobalChatApp);
    const conceptSketchUrl = await getDownloadURL(ConceptSketch);
    const frontendPlaygroundUrl = await getDownloadURL(FrontendPlayground);
                ...
                <div className="w-full h-full inline-block z-0 bg-white p-32 pt-16 mt-0 xl:p-24 lg:p-20 md:p-20 sm:p-8">
                    ...
                    <div className='col-span-12'>
                            <FeaturedProject
                                ...
                                summary='A real-time chat application that allows users to communicate in upto 10 different languages with AI translation.'
                                link="https://chat.anshdeepsingh.com/"
                                type='Featured Project - Web App'
                                img={globalChatAppUrl}
                                github='https://github.com/Anshdeep-Singh'
                            />
                        </div>
                        ...
                        <div className='col-span-6 sm:col-span-12'>
                            <Project
                                ...
                                type="Web App"
                                img={frontendPlaygroundUrl}
                                link="https://playground.anshdeepsingh.com/"
                                github='https://github.com/Anshdeep-Singh'
                            />
                        </div>
                        ...
                        <div className='col-span-6 sm:col-span-12'>
                            <Project
                                ...
                                link="https://sketch.anshdeepsingh.com/"
                                type='Web App'
                                img={conceptSketchUrl}
                                github='https://github.com/Anshdeep-Singh'
                            />
                        </div>
