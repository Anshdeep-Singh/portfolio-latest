...
const page = async () => {
  ...
  return (
    ...
    <main className="flex flex-col items-center text-dark w-full flex-grow pt-0">
      <a href="https://new.anshdeepsingh.com" target="_blank" className="flex flex-row w-full bg-gray-100 rounded-lg text-center justify-center items-center text-xs font-mono">
